        ...
        .map((_, index) => {
          return (
            <li className='py-1' key={index}>
              <div
                tabIndex={0}
                className = {classNames('flex items-center text-sm hover:bg-gray-300 transition-all rounded-lg py-2 px-3 cursor-pointer transition-all', {
                  'bg-gray-300': queryConfig?.rating_filter === (5 - index).toString(),
                })}
